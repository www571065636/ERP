<template>
  <div class="page-container">
    <div class="page-header">
      ...
      <el-button v-if="auth.hasPermission('hr:employee:create')" type="primary" @click="openDialog()">
        ...
        <el-table-column label="操作" width="140" fixed="right" align="center">
          <template #default="{ row }">
            <div class="action-btns">
              <el-button v-if="auth.hasPermission('hr:employee:update')" text type="primary" size="small" @click="openDialog(row)">编辑</el-button>
              <span v-if="auth.hasPermission('hr:employee:update') && auth.hasPermission('hr:employee:delete')" class="action-sep">|</span>
              <el-button v-if="auth.hasPermission('hr:employee:delete')" text type="danger" size="small" @click="handleDelete(row)">删除</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
